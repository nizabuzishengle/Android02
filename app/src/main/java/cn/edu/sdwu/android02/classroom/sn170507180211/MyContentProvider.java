...
public class MyContentProvider extends ContentProvider {
    ...
    private static final int SINFLE_STUDENT=1;
    private static final int MULTPLE_STUDENT=2;
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORITY,"student",MULTPLE_STUDENT); /*content://com.inspur.android02/student*/
        uriMatcher.addURI(AUTHORITY,"student/#",SINFLE_STUDENT);/*content://com.inspur.android02/student/1*/
    }
    ...
    public String getType(Uri uri) {
        ...
        //返回共享数据的MIME类型
        //通过Uri数据，利用 UriMatcher 判断请求单眺还是多条
    ...
    public boolean onCreate() {
        ...
        return true;//初始化的结果，true代表成功
    }

    @Override
    public Cursor query(Uri uri, String[] projection, String selection,
                        String[] selectionArgs, String sortOrder) {
        if (uriMatcher.match(uri)==SINFLE_STUDENT){
            String id=uri.getLastPathSegment();
            if (selection!=null&&selection.length()>0){
                selection+="and id="+id;
            }else{
